...
from utils.metrics_nocs import align, draw_detections, prepare_data_posefitting
...
gt_class_ids, gt_scores, gt_masks, gt_coords, gt_boxes = prepare_data_posefitting(_mask_sem, coords)

result = {}
result["gt_RTs"], scales, error_message, _ = align(
    gt_class_ids, gt_masks, gt_coords, _syn_depth, intrinsics, synset_names
)
