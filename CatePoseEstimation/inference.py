...
parser.add_argument(
    "--train_data_path", type=str, default="/data/DREDS/DREDS-CatKnown/train", help="root dir for training dataset"
)
parser.add_argument("--train_obj_path", type=str, default="/data/cad_model/syn_train", help="root dir for obj")

parser.add_argument("--val_data_path", type=str, default="/data/DREDS/DREDS-CatKnown/test", help="root dir for data")
parser.add_argument("--val_data_type", type=str, default="sim", help="type of val dataset")
parser.add_argument("--val_obj_path", type=str, default="/data/cad_model/syn_test", help="root dir for obj")
parser.add_argument("--val_depth_path", type=str, default="/data/DREDS/DREDS-CatKnown/test", help="root dir for depth")


parser.add_argument("--output_dir", type=str, default="results/inference", help="output dir")
parser.add_argument("--decode_mode", type=str, default="multi_head", help="Select encode mode")
parser.add_argument(
    "--checkpoint_save_path", type=str, default="results/inference", help="Choose a path to save checkpoints"
)


parser.add_argument(
    "--val_interation_interval", type=int, default=5000, help="The iteration interval to perform validation"
)

parser.add_argument(
    "--percentageDataForTraining", type=float, default=1.0, help="The percentage of full training data for training"
)
parser.add_argument(
    "--percentageDataForVal", type=float, default=1.0, help="The percentage of full training data for training"
)
