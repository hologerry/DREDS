...
class SwinDRNet(nn.Module):
    ...
    def __init__(self, config, img_size=224, num_classes=3):
        ...
        self.decode_head_depth_restoration = UPerHead(
            num_classes=1, in_channels=[288, 576, 1152, 2304], img_size=self.img_size
        )
        self.decode_head_confidence = UPerHead(
            num_classes=2, in_channels=[288, 576, 1152, 2304], img_size=self.img_size
        )
